			...
			<div id="sidebar-left" class="span2">
				<div class="nav-collapse sidebar-nav">
					<ul class="nav nav-tabs nav-stacked main-menu">
						...
						<li><a href="{{route('category.index')}}"><i class="icon-envelope"></i><span class="hidden-tablet"> All Category</span></a></li>
						<li><a href="{{route('category.create')}}"><i class="icon-tasks"></i><span class="hidden-tablet"> Add Category</span></a></li>
						<li><a href="{{route('manufacture.index')}}"><i class="icon-eye-open"></i><span class="hidden-tablet"> All Manufactures</span></a></li>
						<li><a href="{{route('manufacture.create')}}"><i class="icon-dashboard"></i><span class="hidden-tablet"> Add Manufactures</span></a></li>
						<li>
							...
							<ul>
								<li ><a class="submenu" href="{{route('rate.index')}}" style="background-color: blue;" ><i class="icon-file-alt"></i><span class="hidden-tablet"> All  Products</span></a></li>
								<li><a class="submenu" href="{{route('rate.create')}}" style="background-color: blue;"><i class="icon-file-alt"></i><span class="hidden-tablet"> Add Products</span></a>
							</ul>	
						</li>
						
						<li><a href="{{ route('myslider.index') }}"><i class="icon-edit"></i><span class="hidden-tablet">All Sliders</span></a></li>
